...
def run(
    ...
    # Initialize change detection (added by kiokahn, 20220608)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        # Initialize detected array (added by kiokahn, 20220608)
        ...
        for i, det in enumerate(pred):  # per image
            ...
            # Send to server if change detected (added by kiokahn, 20220608)
